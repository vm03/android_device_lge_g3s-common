...
# Specific overlay
DEVICE_PACKAGE_OVERLAYS += device/lge/g3s-common/overlay
...
$(call inherit-product-if-exists, vendor/lge/g3s-common/g3s-common-vendor.mk)

# Ramdisk
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,device/lge/g3s-common/rootdir,root)

# Prebuilt
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,device/lge/g3s-common/prebuilt/system,system)
