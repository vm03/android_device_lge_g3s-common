...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/lge/g3s-common/bluetooth
BOARD_HAVE_BLUETOOTH := true
BOARD_BLUEDROID_VENDOR_CONF := device/lge/g3s-common/bluetooth/vnd_g3s.txt
...
BOARD_HARDWARE_CLASS := device/lge/g3s-common/cmhw/
...
# Recovery
TARGET_RECOVERY_FSTAB := device/lge/g3s-common/rootdir/fstab.msm8226
TARGET_RECOVERY_PIXEL_FORMAT := "RGBX_8888"
BOARD_HAS_NO_SELECT_BUTTON := true
DEVICE_RESOLUTION := 720x1280

# RIL
BOARD_RIL_CLASS := ../../../device/lge/g3s-common/ril/
...
-include vendor/lge/g3s-common/BoardConfigVendor.mk
